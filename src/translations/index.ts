export const translations = {
  en: {
    hero: {
      title: "Gwan Company",
      subtitle: "One Developer, Infinite Possibilities",
      ...
      items: [
        {
          icon: "🤖",
          title: "AI-Powered",
          description: "Enhanced development with cutting-edge AI tools"
        },
        {
          icon: "⚡",
        ...
        },
        {
          icon: "🎯",
          title: "Precision",
          description: "Focused, high-quality solutions"
        },
        {
          icon: "💡",
          title: "Innovation",
          description: "Modern tech stack with AI integration"
        }
      ]
    },
    approach: {
